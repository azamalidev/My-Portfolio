      ...
      <div className='w-[50px] mx-auto overflow-hidden'>
        ...
        >
                  ...
                  <div className='row col-sm-10 '>
                    ...
                    >
                      <em>
                        ...
                        <p>
                          <strong>Duration:</strong> [2023] – [2025] (2 Years)
                        </p>
                        <p>
                          Designed and developed dynamic web applications,
                          implemented optimized backend solutions, and
                          collaborated on projects that enhanced user engagement
                  ...
                  <div className='row col-sm-10 '>
                    ...
                    >
                      <em>
                        ...
                        <p>
                          Currently contributing to the development of scalable
                          and high-performance web applications, collaborating
                          with a talented team to build innovative digital
                          solutions.
                        </p>
                      </em>
                    </p>
          ...
          <div className={`${styles.timeLine} mb-5 text-center`}>
            ...
            {/* Container 1 */}
            <div
              className={`${styles.container} ${styles.leftContainer} mt-5 `}
            >
              ...
              >
                ...
                <p>
                  ...
                  After my interniship in MERN stack. I developed my first
                  Backend Project Which was capmany website backend.
                </p>
                <span
                  className={
                    darkMode
            ...
            <div className={`${styles.container} ${styles.rightContainer}`}>
              ...
              >
                ...
                <p>
                  ...
                  staff. It have different types of user. Here user can create
                  his own page where he can list there tasks.
                </p>
                <span
                  className={
                    darkMode
            ...
            <div className={`${styles.container} ${styles.leftContainer}`}>
              ...
              >
                ...
                <p>
                  ...
                  Express.js. Main idea of this app is to serve peopleat there
                  own home solve there home defacts such as water pump repairing
            ...
            <div className={`${styles.container} ${styles.rightContainer}`}>
              ...
              >
                ...
                <p>
                  It is Frontend web application with purpose of shipping.In
                  this site there are two type of user where one is admin other
                  is local user. User can set there ship item and also can set
                  its prize.
                </p>
                <span
                  className={
            ...
            <div className={`${styles.container} ${styles.leftContainer}`}>
              ...
              >
                <h2>Service Now USA</h2>
                <small>2024</small>
                <small className='p-1 m-1 text-white bg-primary rounded stretched-link'>
                  Not Deployed
                </small>
                <p>
                  Service Now-USA is a job hunting and job providing web
                  application that connects job seekers and employers
                  efficiently. As a MERN stack developer, I contributed to
                  building this platform by developing dynamic user interfaces
                  with React.js, creating server-side logic using Node.js and
                  Express.js, and managing data with MongoDB. I implemented
                  secure user authentication, integrated RESTful APIs, and
                  optimized application performance. Additionally, I handled the
                  deployment and maintenance of the application on AWS, ensuring
            ...
            <div className={`${styles.container} ${styles.rightContainer}`}>
              ...
              >
                ...
                <p>
                  Apart Luxury is a premium web application designed for the
                  elite class, offering a curated selection of high-end
                  properties, apartments, homes, and shops. The platform
                  provides a seamless and luxurious browsing experience,
                  catering to discerning clients seeking exclusive and upscale
                  real estate options."
                </p>
                <span
                  className={
