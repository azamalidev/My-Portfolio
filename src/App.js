...
function App() {
  ...
  const sendEmail = async (e) => {
    ...
    if (user && email && message) {
      await emailjs.send('service_d5pyqbm', 'template_8yujids', {
        user_name: user,
        user_email: email,
        message: message,
      });
      ...
      >
        ...
        <div className={`${styles.timeLine} mb-5 text-center`}>
          ...
          <div className={`${styles.container} ${styles.leftContainer}`}>
            ...
            >
              ...
              <p>
                ...
                application that connects job seekers and employers efficiently.
                As a MERN stack developer, I contributed to building this
                platform by developing dynamic user interfaces with React.js,
                creating server-side logic using Node.js and Express.js, and
                managing data with MongoDB. I implemented secure user
                authentication, integrated RESTful APIs, and optimized
                application performance. Additionally, I handled the deployment
                and maintenance of the application on AWS, ensuring a seamless
          ...
          <div className={`${styles.container} ${styles.rightContainer}`}>
            ...
            >
              ...
              <p>
                Apart Luxury is a premium web application designed for the elite
                class, offering a curated selection of high-end properties,
                apartments, homes, and shops. The platform provides a seamless
                and luxurious browsing experience, catering to discerning
                clients seeking exclusive and upscale real estate options."
              </p>
              <span
                className={
                  darkMode
        ...
        >
          ...
          <div className='col-sm-4 d-flex'>
            <div
               className={styles.contactUs_icon}
          ...
          <div className='col-sm-2 mt-3 '>
            ...
            >
              ...
              <span
                ...
                className='text-white'
              >
                Pakistan,Punjab,Raheem Yar Khan.
              </span>
            </div>
          </div>
          <div
