  ...
  return (
    <div className="container text-center p-2 mt-5 max-w-screen-md mx-auto overflow-hidden">
      <div className={styles.sectionHeader}>
        <div className={styles.sectionEyebrow}><svg width="8" height="8" viewBox="0 0 8 8" fill="#3FFF00"><circle cx="4" cy="4" r="4"/></svg>Expertise</div>
        <h2 className={styles.sectionTitle}>Skills & Tools</h2>
        <p className={styles.sectionSubtitle}>
          Technologies and tools I work with daily to build modern, scalable applications.
        </p>
      </div>
